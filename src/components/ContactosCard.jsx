...
export const ContactCard = ({ contacto, index, tarjetasVolteadas, voltearTarjeta}) => {
    ...
    return (
        ...
        <TouchableOpacity key={index} style={styles.cardContainer} onPress={() => voltearTarjeta(index)}>
                    ...
                    <View
                        ...
                        style={[
                            styles.cardFront, //
                            {
                                ...
                                transform: tarjetasVolteadas[index] ? [{ rotateY: "180deg" }] : [{ rotateY: "0deg" }],
                            },
                        ]}
                    >
                    ...
                    <View
                        ...
                        style={[
                            styles.cardBack,
                            {
                                ...
                                transform: tarjetasVolteadas[index] ? [{ rotateY: "0deg" }] : [{ rotateY: "180deg" }],
                            },
                        ]}
                    > 
                         <ImageBackground
                        ...
                        >
                            ...
                            {contacto.boldText && <Text style={styles.boldText}>{contacto.boldText}</Text>}
                        </ImageBackground>
                    </View>
